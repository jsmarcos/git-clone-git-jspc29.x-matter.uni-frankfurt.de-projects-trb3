...
-- Module  Version: 6.1
--/home/soft/lattice/diamond/2.1_x64/ispfpga/bin/lin64/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type bram -wp 10 -rp 0011 -rdata_width 50 -data_width 50 -num_rows 16 -outdata REGISTERED -cascade -1 -e 

-- Fri Feb 27 13:16:39 2015
...
architecture Structure of dpram_50x16 is
    ...
    attribute MEM_LPC_FILE of dpram_50x16_0_0_1 : label is "dpram_50x16.lpc";
    attribute MEM_INIT_FILE of dpram_50x16_0_0_1 : label is "";
    attribute RESETMODE of dpram_50x16_0_0_1 : label is "SYNC";
    attribute MEM_LPC_FILE of dpram_50x16_0_1_0 : label is "dpram_50x16.lpc";
    attribute MEM_INIT_FILE of dpram_50x16_0_1_0 : label is "";
    attribute RESETMODE of dpram_50x16_0_1_0 : label is "SYNC";
    attribute NGD_DRC_MASK : integer;
    attribute NGD_DRC_MASK of Structure : architecture is 1;

begin
    -- component instantiation statements
    dpram_50x16_0_0_1: PDPW16KC
        ...
        port map (DI0=>Data(0), DI1=>Data(1), DI2=>Data(2), DI3=>Data(3), 
            ...
            ADW3=>WrAddress(3), ADW4=>scuba_vlo, ADW5=>scuba_vlo, 
            ...
            ADR7=>RdAddress(2), ADR8=>RdAddress(3), ADR9=>scuba_vlo, 
    ...
    dpram_50x16_0_1_0: PDPW16KC
        ...
        port map (DI0=>Data(36), DI1=>Data(37), DI2=>Data(38), 
            ...
            ADW2=>WrAddress(2), ADW3=>WrAddress(3), ADW4=>scuba_vlo, 
            ADW5=>scuba_vlo, ADW6=>scuba_vlo, ADW7=>scuba_vlo, 
            ADW8=>scuba_vlo, BE0=>scuba_vhi, BE1=>scuba_vhi, 
            BE2=>scuba_vhi, BE3=>scuba_vhi, CEW=>WrClockEn, 
            CLKW=>WrClock, CSW0=>WE, CSW1=>scuba_vlo, CSW2=>scuba_vlo, 
            ADR0=>scuba_vlo, ADR1=>scuba_vlo, ADR2=>scuba_vlo, 
            ADR3=>scuba_vlo, ADR4=>scuba_vlo, ADR5=>RdAddress(0), 
            ADR6=>RdAddress(1), ADR7=>RdAddress(2), ADR8=>RdAddress(3), 
            ADR9=>scuba_vlo, ADR10=>scuba_vlo, ADR11=>scuba_vlo, 
            ADR12=>scuba_vlo, ADR13=>scuba_vlo, CER=>RdClockEn, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of dpram_50x16 is
    for Structure
