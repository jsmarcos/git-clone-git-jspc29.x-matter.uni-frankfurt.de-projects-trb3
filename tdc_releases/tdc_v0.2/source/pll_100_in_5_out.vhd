...
-- Module  Version: 5.2
--/opt/lattice/diamond/1.4/ispfpga/bin/lin/scuba -w -n pll_100_in_5_out -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 5 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -e 

-- Mon Feb 20 14:01:28 2012
...
entity pll_100_in_5_out is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of pll_100_in_5_out : entity is true;
end pll_100_in_5_out;

architecture Structure of pll_100_in_5_out is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "5.000000";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  128, CLKFB_DIV=>  1, CLKI_DIV=>  20, 
        FIN=> "100.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_100_in_5_out is
    for Structure
