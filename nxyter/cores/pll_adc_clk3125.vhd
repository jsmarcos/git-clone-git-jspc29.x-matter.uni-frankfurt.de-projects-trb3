...
-- Module  Version: 5.3
--/usr/local/opt/lattice_diamond/diamond/2.0/ispfpga/bin/lin/scuba -w -n pll_adc_clk3125 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 125 -phase_cntl STATIC -fclkop 31.25 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -bw -e 

-- Thu Mar 28 18:11:07 2013
...
entity pll_adc_clk3125 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of pll_adc_clk3125 : entity is true;
end pll_adc_clk3125;

architecture Structure of pll_adc_clk3125 is
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_adc_clk3125 is
    for Structure
