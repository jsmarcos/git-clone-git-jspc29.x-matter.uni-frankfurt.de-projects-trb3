...
-- Module  Version: 5.7
--/d/jspc29/lattice/diamond/3.4_x64/ispfpga/bin/lin64/scuba -w -n pll -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 200 -phase_cntl DYNAMIC -fclkop 200 -fclkop_tol 0.0 -fb_mode CLOCKTREE -duty50 -fclkok 100 -fclkok_tol 0.0 -clkoki 0 -use_rst -noclkok2 -bw 

-- Fri Apr 17 17:34:37 2015
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        port map (CLKI=>CLK, CLKFB=>CLKOP_t, RST=>RESET, RSTK=>scuba_vlo, 
            ...
            FDA0=>FINEDELB0, CLKOP=>CLKOP_t, CLKOS=>CLKOS_t, 
            CLKOK=>CLKOK, CLKOK2=>open, LOCK=>LOCK, CLKINTFB=>open);
