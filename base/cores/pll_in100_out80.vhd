...
-- Module  Version: 5.3
--/d/jspc29/lattice/diamond/2.01/ispfpga/bin/lin/scuba -w -n pll_in100_out80 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 200 -phase_cntl STATIC -fclkop 80 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -bw -e 

-- Thu Mar 14 20:17:20 2013
...
entity pll_in100_out80 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of pll_in100_out80 : entity is true;
end pll_in100_out80;

architecture Structure of pll_in100_out80 is
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_in100_out80 is
    for Structure
