...
-- Module  Version: 5.7
--/opt/lattice/diamond/3.3_x64/ispfpga/bin/lin64/scuba -w -n FIFO_DC_36x128_DynThr_OutReg -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 128 -width 36 -depth 128 -rdata_width 36 -regout -no_enable -pe -1 -pf 0 

-- Mon Dec 15 12:30:58 2014
...
entity FIFO_DC_36x128_DynThr_OutReg is
    port (
...
architecture Structure of FIFO_DC_36x128_DynThr_OutReg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "FIFO_DC_36x128_DynThr_OutReg.lpc";
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of FIFO_DC_36x128_DynThr_OutReg is
    for Structure
