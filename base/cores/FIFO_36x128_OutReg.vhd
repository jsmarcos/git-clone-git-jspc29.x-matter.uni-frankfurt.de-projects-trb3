...
-- Module  Version: 4.8
--/opt/lattice/diamond/2.01/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 128 -width 36 -depth 128 -regout -no_enable -pe 3 -pf -1 -e 

-- Tue Oct 15 10:43:36 2013
...
begin
  ...
  ae_cmp_0 : ALEB2
    port map (A0 => fcount_0, A1 => fcount_1, B0 => fcnt_en_inv,
              B1 => r_nw_inv, CI => cmp_ci_2, LE => co0_5);

  ae_cmp_1 : ALEB2
    port map (A0 => fcount_2, A1 => fcount_3, B0 => r_nw, B1 => scuba_vlo,
              CI => co0_5, LE => co1_5);
  ...
  ae_cmp_3 : ALEB2
    port map (A0 => fcount_6, A1 => fcount_7, B0 => scuba_vlo,
              B1 => scuba_vlo, CI => co2_5, LE => ae_d_c);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of FIFO_36x128_OutReg is
  for Structure
