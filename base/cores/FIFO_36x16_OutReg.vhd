...
-- Module  Version: 4.9
--/opt/lattice/diamond/3.0_x64/ispfpga/bin/lin64/scuba -w -n FIFO_36x16_OutReg -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 16 -width 36 -depth 16 -regout -no_enable -pe -1 -pf -1 -e 

-- Wed May  7 16:30:22 2014
...
entity FIFO_36x16_OutReg is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end FIFO_36x16_OutReg;

architecture Structure of FIFO_36x16_OutReg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "FIFO_36x16_OutReg.lpc";
...
begin
    ...
    pdp_ram_0_0_0: PDPW16KC
        ...
        port map (DI0=>Data(0), DI1=>Data(1), DI2=>Data(2), DI3=>Data(3), 
            ...
            ADW3=>wcount_3, ADW4=>scuba_vlo, ADW5=>scuba_vlo, 
            ...
            ADR7=>rcount_2, ADR8=>rcount_3, ADR9=>scuba_vlo, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of FIFO_36x16_OutReg is
    for Structure
