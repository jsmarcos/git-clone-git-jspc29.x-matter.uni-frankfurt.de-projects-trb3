...
-- Module  Version: 5.7
--/opt/lattice/diamond/3.4_x64/ispfpga/bin/lin64/scuba -w -n pll_calibration -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 20 -phase_cntl STATIC -fclkop 100 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -bw 

-- Fri Feb 13 16:40:26 2015
...
entity pll_calibration is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of pll_calibration : entity is true;
end pll_calibration;

architecture Structure of pll_calibration is
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_calibration is
    for Structure
