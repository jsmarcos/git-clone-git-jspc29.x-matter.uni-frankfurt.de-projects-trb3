...
-- Module  Version: 5.4
--/d/jspc29/lattice/diamond/1.4.2.105/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 16 -width 60 -depth 16 -rdata_width 60 -regout -no_enable -pe -1 -pf -1 -e 

-- Thu Aug 16 10:56:11 2012
...
architecture Structure of fifo_cdt_200 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_1 : label is "fifo_cdt_200.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_1 : label is "";
    attribute RESETMODE of pdp_ram_0_0_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_0 : label is "fifo_cdt_200.lpc";
...
begin
    ...
    pdp_ram_0_1_0: PDPW16KC
        ...
        port map (DI0=>Data(36), DI1=>Data(37), DI2=>Data(38), 
            ...
            DI23=>Data(59), DI24=>scuba_vlo, DI25=>scuba_vlo, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of fifo_cdt_200 is
    for Structure
