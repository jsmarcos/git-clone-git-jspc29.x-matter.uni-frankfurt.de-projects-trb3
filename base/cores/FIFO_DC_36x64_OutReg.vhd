...
-- Module  Version: 5.5
--/opt/lattice/diamond/3.0_x64/ispfpga/bin/lin64/scuba -w -n FIFO_DC_36x64_OutReg -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 64 -width 36 -depth 64 -rdata_width 36 -regout -no_enable -pe -1 -pf 54 -e 

-- Thu Apr 24 11:26:01 2014
...
entity FIFO_DC_36x64_OutReg is
    port (
...
end FIFO_DC_36x64_OutReg;

architecture Structure of FIFO_DC_36x64_OutReg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "FIFO_DC_36x64_OutReg.lpc";
...
begin
    ...
    LUT4_1: ROM16X1A
        ...
        port map (AD3=>af_setcount_6, AD2=>wcount_6, AD1=>r_gcount_w26, 
    ...
    pdp_ram_0_0_0: PDPW16KC
        ...
        port map (DI0=>Data(0), DI1=>Data(1), DI2=>Data(2), DI3=>Data(3), 
            ...
            ADW5=>wptr_5, ADW6=>scuba_vlo, ADW7=>scuba_vlo, 
    ...
    af_set_ctr_3: CU2
        port map (CI=>co2_4, PC0=>af_setcount_6, PC1=>scuba_vlo, 
            CO=>co3_2, NC0=>iaf_setcount_6, NC1=>open);
    ...
    af_set_cmp_1: AGEB2
        port map (A0=>af_setcount_2, A1=>af_setcount_3, B0=>rcount_w2, 
            B1=>r_g2b_xor_cluster_0, CI=>co0_5, GE=>co1_5);
    ...
    af_set_cmp_3: AGEB2
        port map (A0=>af_set_cmp_set, A1=>scuba_vlo, B0=>af_set_cmp_clr, 
            B1=>scuba_vlo, CI=>co2_5, GE=>af_set_c);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of FIFO_DC_36x64_OutReg is
    for Structure
