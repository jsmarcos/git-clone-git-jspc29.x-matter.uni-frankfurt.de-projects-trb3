...
-- Module  Version: 5.5
--/opt/lattice/diamond/3.0_x64/ispfpga/bin/lin64/scuba -w -n FIFO_DC_36x128_OutReg -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 128 -width 36 -depth 128 -rdata_width 36 -regout -no_enable -pe -1 -pf 118 -e 

-- Thu Apr 24 10:26:28 2014
...
entity FIFO_DC_36x128_OutReg is
    port (
...
end FIFO_DC_36x128_OutReg;

architecture Structure of FIFO_DC_36x128_OutReg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "FIFO_DC_36x128_OutReg.lpc";
...
begin
    ...
    af_set_ctr_3: CU2
        port map (CI=>co2_4, PC0=>af_setcount_6, PC1=>af_setcount_7, 
            CO=>co3_2, NC0=>iaf_setcount_6, NC1=>iaf_setcount_7);
    ...
    af_set_cmp_2: AGEB2
        port map (A0=>af_setcount_4, A1=>af_setcount_5, 
            B0=>r_g2b_xor_cluster_0, B1=>rcount_w5, CI=>co1_5, GE=>co2_5);

    af_set_cmp_3: AGEB2
        port map (A0=>af_setcount_6, A1=>af_set_cmp_set, B0=>rcount_w6, 
            B1=>af_set_cmp_clr, CI=>co2_5, GE=>af_set_c);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of FIFO_DC_36x128_OutReg is
    for Structure
