...
-- Module  Version: 5.7
--/usr/local/opt/lattice_diamond/diamond/3.4/ispfpga/bin/lin64/scuba -w -n fifo_6to6_dc -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 4 -width 6 -depth 4 -rdata_width 6 -regout -no_enable -pe -1 -pf -1 

-- Mon Jun 15 23:21:51 2015
...
architecture Structure of fifo_6to6_dc is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "fifo_6to6_dc.lpc";
...
begin
    ...
    pdp_ram_0_0_0: DP16KC
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            DIA7=>scuba_vlo, DIA8=>scuba_vlo, DIA9=>scuba_vlo, 
            ...
            ADB2=>scuba_vlo, ADB3=>rptr_0, ADB4=>rptr_1, ADB5=>scuba_vlo, 
            ...
            DOB4=>Q(4), DOB5=>Q(5), DOB6=>open, DOB7=>open, DOB8=>open, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of fifo_6to6_dc is
    for Structure
