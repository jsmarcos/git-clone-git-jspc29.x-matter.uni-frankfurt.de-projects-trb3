...
-- Module  Version: 4.5
--/usr/local/opt/lattice_diamond/diamond/3.4/ispfpga/bin/lin64/scuba -w -n counter_45bit -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type counter -up -width 45 -group 16 

-- Mon Jun  8 02:11:09 2015
...
architecture Structure of counter_45bit is

    -- internal signal declarations
    signal tdataout1_inv: std_logic;
    ...
    signal group_cout_pre: std_logic;
    signal group_cout0: std_logic;
    signal group_cout1: std_logic;
    signal group_cout_pre_1: std_logic;
    signal group_cin_pre_1: std_logic;
    ...
    signal group_cin0: std_logic;
    signal idataout16: std_logic;
    signal idataout17: std_logic;
    signal cntGrpCinNet_1: std_logic;
    ...
    signal group_cin1: std_logic;
    signal idataout32: std_logic;
    signal idataout33: std_logic;
    signal cntGrpCinNet_2: std_logic;
...
begin
    ...
    INV_0: INV
        port map (A=>tdataout1, Z=>tdataout1_inv);

    LUT4_10: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>tdataout0, AD2=>tdataout1_inv, AD1=>tdataout2, 
            AD0=>tdataout3, DO0=>func_and_inet);

    LUT4_9: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>tdataout4, AD2=>tdataout5, AD1=>tdataout6, 
            AD0=>tdataout7, DO0=>func_and_inet_1);

    LUT4_8: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>tdataout8, AD2=>tdataout9, AD1=>tdataout10, 
            AD0=>tdataout11, DO0=>func_and_inet_2);

    LUT4_7: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>tdataout12, AD2=>tdataout13, AD1=>tdataout14, 
            AD0=>tdataout15, DO0=>func_and_inet_3);

    LUT4_6: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>func_and_inet, AD2=>func_and_inet_1, 
            AD1=>func_and_inet_2, AD0=>func_and_inet_3, 
            DO0=>group_cout_pre);

    LUT4_5: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>tdataout16, AD2=>tdataout17, AD1=>tdataout18, 
            AD0=>tdataout19, DO0=>func_and_inet_4);

    LUT4_4: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>tdataout20, AD2=>tdataout21, AD1=>tdataout22, 
            AD0=>tdataout23, DO0=>func_and_inet_5);

    LUT4_3: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>tdataout24, AD2=>tdataout25, AD1=>tdataout26, 
            AD0=>tdataout27, DO0=>func_and_inet_6);

    LUT4_2: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>tdataout28, AD2=>tdataout29, AD1=>tdataout30, 
            AD0=>tdataout31, DO0=>func_and_inet_7);

    LUT4_1: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>func_and_inet_4, AD2=>func_and_inet_5, 
            AD1=>func_and_inet_6, AD0=>func_and_inet_7, 
            DO0=>group_cout_pre_1);

    LUT4_0: ROM16X1A
        generic map (initval=> X"8000")
        port map (AD3=>group_cout0, AD2=>group_cout1, AD1=>scuba_vhi, 
            AD0=>scuba_vhi, DO0=>group_cin_pre_1);
    ...
    FF_3: FD1P3DX
        port map (D=>group_cout_pre, SP=>Clk_En, CK=>Clock, CD=>Aclr, 
            Q=>group_cout0);

    FF_2: FD1P3DX
        port map (D=>group_cout0, SP=>Clk_En, CK=>Clock, CD=>Aclr, 
            Q=>group_cin0);

    FF_1: FD1P3DX
        port map (D=>group_cout_pre_1, SP=>Clk_En, CK=>Clock, CD=>Aclr, 
            Q=>group_cout1);

    FF_0: FD1P3DX
        port map (D=>group_cin_pre_1, SP=>Clk_En, CK=>Clock, CD=>Aclr, 
            Q=>group_cin1);
    ...
    cntGrpCinInst_1: FADD2B
        port map (A0=>scuba_vlo, A1=>group_cin0, B0=>scuba_vlo, 
            B1=>group_cin0, CI=>scuba_vlo, COUT=>cntGrpCinNet_1, 
            S0=>open, S1=>open);

    cnt_8: CU2
        port map (CI=>cntGrpCinNet_1, PC0=>tdataout16, PC1=>tdataout17, 
            CO=>co8, NC0=>idataout16, NC1=>idataout17);
    ...
    cntGrpCinInst_2: FADD2B
        port map (A0=>scuba_vlo, A1=>group_cin1, B0=>scuba_vlo, 
            B1=>group_cin1, CI=>scuba_vlo, COUT=>cntGrpCinNet_2, 
            S0=>open, S1=>open);

    cnt_16: CU2
        port map (CI=>cntGrpCinNet_2, PC0=>tdataout32, PC1=>tdataout33, 
            CO=>co16, NC0=>idataout32, NC1=>idataout33);
    ...
    cnt_22: CU2
        port map (CI=>co21, PC0=>tdataout44, PC1=>scuba_vlo, CO=>co22, 
            NC0=>idataout44, NC1=>open);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of counter_45bit is
    for Structure
