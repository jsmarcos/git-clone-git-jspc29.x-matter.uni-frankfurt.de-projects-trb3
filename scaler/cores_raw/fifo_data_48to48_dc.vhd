...
-- Module  Version: 5.7
--/usr/local/opt/lattice_diamond/diamond/3.4/ispfpga/bin/lin64/scuba -w -n fifo_data_48to48_dc -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 4 -width 48 -depth 4 -rdata_width 48 -regout -no_enable -pe -1 -pf -1 

-- Sun Jun  7 15:40:01 2015
...
entity fifo_data_48to48_dc is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifo_data_48to48_dc;

architecture Structure of fifo_data_48to48_dc is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_1 : label is "fifo_data_48to48_dc.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_1 : label is "";
    attribute RESETMODE of pdp_ram_0_0_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_0 : label is "fifo_data_48to48_dc.lpc";
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of fifo_data_48to48_dc is
    for Structure
