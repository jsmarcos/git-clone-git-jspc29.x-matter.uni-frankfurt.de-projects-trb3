...
-- Module  Version: 5.7
--/usr/local/opt/lattice_diamond/diamond/3.4/ispfpga/bin/lin64/scuba -w -n pll_clk500 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 200 -phase_cntl STATIC -fclkop 500 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -use_rst -noclkok2 -bw 

-- Mon Jun  8 20:38:29 2015
...
entity pll_clk500 is
 ...
 attribute dont_touch of pll_clk500 : entity is true;
end pll_clk500;

architecture Structure of pll_clk500 is
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_clk500 is
    for Structure
