...
-- Module  Version: 5.7
--/usr/local/opt/lattice_diamond/diamond/3.4/ispfpga/bin/lin64/scuba -w -n pll_clk_scaler -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 200 -phase_cntl STATIC -fclkop 500 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 250 -fclkok_tol 0.0 -clkoki 0 -use_rst -noclkok2 -bw 

-- Fri Jun 12 16:57:24 2015
...
entity pll_clk_scaler is
 ...
 attribute dont_touch of pll_clk_scaler : entity is true;
end pll_clk_scaler;

architecture Structure of pll_clk_scaler is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "500.000000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "200.000000";
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "250.000000";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  2, CLKFB_DIV=>  5, CLKI_DIV=>  2, 
        FIN=> "200.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_clk_scaler is
    for Structure
