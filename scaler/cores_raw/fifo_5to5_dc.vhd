...
-- Module  Version: 5.7
--/usr/local/opt/lattice_diamond/diamond/3.4/ispfpga/bin/lin64/scuba -w -n fifo_5to5_dc -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 4 -width 5 -depth 4 -rdata_width 5 -regout -no_enable -pe -1 -pf -1 

-- Fri Aug 14 23:11:04 2015
...
architecture Structure of fifo_5to5_dc is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "fifo_5to5_dc.lpc";
...
begin
    ...
    pdp_ram_0_0_0: DP16KC
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            DIA3=>Data(3), DIA4=>Data(4), DIA5=>scuba_vlo, 
            ...
            ADA3=>wptr_0, ADA4=>wptr_1, ADA5=>scuba_vlo, ADA6=>scuba_vlo, 
            ...
            DOB4=>Q(4), DOB5=>open, DOB6=>open, DOB7=>open, DOB8=>open, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of fifo_5to5_dc is
    for Structure
