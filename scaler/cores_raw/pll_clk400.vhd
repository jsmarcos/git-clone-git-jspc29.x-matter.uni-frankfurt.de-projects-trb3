...
-- Module  Version: 5.6
--/usr/local/opt/lattice_diamond/diamond/3.2/ispfpga/bin/lin64/scuba -w -n pll_clk400 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 200 -phase_cntl STATIC -fclkop 400 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -use_rst -noclkok2 -bw 

-- Fri Jun  5 16:41:32 2015
...
entity pll_clk400 is
 ...
 attribute dont_touch of pll_clk400 : entity is true;
end pll_clk400;

architecture Structure of pll_clk400 is
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_clk400 is
    for Structure
