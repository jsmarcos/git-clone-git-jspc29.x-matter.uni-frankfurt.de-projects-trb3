...
-- Module  Version: 5.7
--/usr/local/opt/lattice_diamond/diamond/3.4/ispfpga/bin/lin64/scuba -w -n pll_quadruple -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 25 -phase_cntl STATIC -mdiv 1 -ndiv 4 -vdiv 8 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -bw 

-- Wed Aug 12 16:45:01 2015
...
entity pll_quadruple is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of pll_quadruple : entity is true;
end pll_quadruple;

architecture Structure of pll_quadruple is
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  8, CLKFB_DIV=>  4, CLKI_DIV=>  1, 
        FIN=> "25.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_quadruple is
    for Structure
